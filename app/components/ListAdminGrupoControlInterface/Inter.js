...
function GrupoControl({ inter, onEdit, onDelete, onTag }) {
  return (
    <Container>
      ...
      <Info>
        <Title>{inter.nombre}</Title>
      </Info>

      <Actions>
        <Button onClick={() => onTag(inter.idEtiquetaModulo)}>
          <MdAddLocation /> Label
        </Button>
        <Button onClick={() => onEdit(inter.idEtiquetaModulo)}>
          <MdEdit />
        </Button>
        <Button onClick={() => onDelete(inter.idEtiquetaModulo)}>
          <MdDelete />
        </Button>
      </Actions>
    </Container>
