...
// require('../../../node_modules/pdfjs-dist/web/');
...
class Pdf extends Component {
  ...
  onDocumentComplete(pdf) {
    ...
    if (
      typeof onContentAvailable === 'function' ||
      typeof onBinaryContentAvailable === 'function'
    ) {
  ...
  loadPDFDocument(props) {
    if (props.file) {
      ...
      throw new Error(
        'react-pdf-js works with a file(URL) or (base64)content. At least one needs to be provided!',
      );
    }
  }
