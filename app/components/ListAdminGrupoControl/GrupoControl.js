  ...
  return (
    <Container>
      ...
      <Info>
        ...
        <SubTitleContainer>
          <Title>ID: {grupo.idItem}</Title>
          <Title>Instrumento: {grupo.instrumento}</Title>
        </SubTitleContainer>
      </Info>

      <Actions>
        <Button onClick={() => onEdit(grupo.idEnclavamientoAlarma)}>
          <MdEdit />
        </Button>
        <Button onClick={() => onDelete(grupo.idEnclavamientoAlarma)}>
          <MdDelete />
        </Button>
      </Actions>
    </Container>
