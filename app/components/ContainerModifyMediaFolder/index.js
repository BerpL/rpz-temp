...
import { getMediaTreeById } from 'services/ArbolMediosService';
...
function ContainerModifyMediaFolder({ id, onClose, onModify }) {
  ...
  async function getArea() {
    try {
      const response = await getMediaTreeById(id);
...
ContainerModifyMediaFolder.propTypes = {
  id: PropTypes.any,
  onClose: PropTypes.func,
  onModify: PropTypes.func,
};

export default ContainerModifyMediaFolder;
