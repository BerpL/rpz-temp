...
function home_camera() {
  ...
  reiniciar_pasos();
  outline(['ALL_OBJECTS'], 'DISABLE');
  tweenCamera('molienda_Pos14', 'molienda_Dir14', 0.2, function() {}, 0);
...
camara = 'camera1';
setActiveCamera(camara);
setCameraParam('ALLOW_PANNING', camara, true);
setCameraParam('ORBIT_MIN_VERTICAL_ANGLE', camara, 50);
setCameraParam('ORBIT_MAX_VERTICAL_ANGLE', camara, 90);
setCameraParam('ENABLE_COLLISIONS', camara, true);
whenMoved(camara, 0.01, function() {
  console.log(getObjTransform(camara, false, 'position', 'xyz'));
}, function() {
  if (getObjTransform(camara, false, 'position', 'y') <= 38201) {
    setObjTransform(camara, false, 'position', ['', 38201, ''], false);
  }
}, function() {
  console.log(getObjTransform(camara, false, 'position', 'xyz'));
});
...
eventHTMLElem('click', 'paso2', true, function(event) {
  pasos('paso2', '/images/molienda/01-1.png', 'molienda_Pos13', 'molienda_Dir13', 'equipo_200_CV_0102');
});
eventHTMLElem('click', 'paso3', true, function(event) {
  ...
  pasos('paso3', '/images/molienda/01-2.png', 'molienda_Pos12', 'molienda_Dir12', 'equipo_200_CV_0108');
});
eventHTMLElem('click', 'paso4', true, function(event) {
  ...
  pasos('paso4', '/images/molienda/02-1.png', 'molienda_Pos01', 'molienda_Dir01', 'equipo_200_ML_0120');
});
eventHTMLElem('click', 'paso5', true, function(event) {
  ...
  pasos('paso5', '/images/molienda/03-1.png', 'molienda_Pos02', 'molienda_Dir02', 'equipo_200_SR_0124');
});
eventHTMLElem('click', 'paso6', true, function(event) {
  pasos('paso6', '/images/molienda/04-1.png', 'molienda_Pos08', 'molienda_Dir08', 'equipo_200_CV_0125');
});
eventHTMLElem('click', 'paso7', true, function(event) {
  ...
  pasos('paso7', '/images/molienda/04-2.png', 'molienda_Pos09', 'molienda_Dir09', 'equipo_200_CV_0127');
});
eventHTMLElem('click', 'paso8', true, function(event) {
  ...
  pasos('paso8', '/images/molienda/05.png', 'molienda_Pos11', 'molienda_Dir11', 'equipo_200_CR_0130');
});
eventHTMLElem('click', 'paso9', true, function(event) {
  ...
  pasos('paso9', '/images/molienda/06-1.png', 'molienda_Pos05', 'molienda_Dir05', 'equipo_200_PP_0175');
});
eventHTMLElem('click', 'paso10', true, function(event) {
  ...
  pasos('paso10', '/images/molienda/07-1.png', 'molienda_Pos03', 'molienda_Dir03', 'equipo_200_PP_0142');
});
eventHTMLElem('click', 'paso11', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'window.parent.postMessage({param1: 1, param2:25 },\'*\');')(appInstance, v3d, PL, VARS, PROC);

  pasos('paso11', '/images/molienda/07-1.png', 'molienda_Pos03', 'molienda_Dir03', 'equipo_200_PP_0144');
});
eventHTMLElem('click', 'paso12', true, function(event) {
  ...
  pasos('paso12', '/images/molienda/08-1.png', 'molienda_Pos04', 'molienda_Dir04', 'equipo_200_CL_0150');
});
eventHTMLElem('click', 'paso13', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2:26 },\'*\');    }, 100);' + '\n' +
  '});')))(appInstance, v3d, PL, VARS, PROC);

  pasos('paso13', '/images/molienda/09-1.png', 'molienda_Pos10', 'molienda_Dir10', 'equipo_400_SA_0230');
});
...
eventHTMLElem('click', 'paso15', true, function(event) {
  ...
  pasos('paso15', '/images/molienda/10-1.png', 'molienda_Pos06', 'molienda_Dir06', 'equipo_200_TK_0152');
});
eventHTMLElem('click', 'paso16', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'window.parent.postMessage({param1: 1, param2:28 },\'*\');')(appInstance, v3d, PL, VARS, PROC);

  pasos('paso16', '/images/molienda/10-1.png', 'molienda_Pos06', 'molienda_Dir06', 'equipo_200_TK_0171');
});
eventHTMLElem('click', 'paso17', true, function(event) {
  ...
  pasos('paso17', '/images/molienda/11-1.png', 'molienda_Pos07', 'molienda_Dir07', 'equipo_200_PP_0156');
});
eventHTMLElem('click', 'paso18', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'window.parent.postMessage({param1: 1, param2:29 },\'*\');')(appInstance, v3d, PL, VARS, PROC);

  pasos('paso18', '/images/molienda/11-1.png', 'molienda_Pos07', 'molienda_Dir07', 'equipo_200_PP_0158');
});
...
'        var groundY = intersects[0].point.y + 5;' + '\n' +
