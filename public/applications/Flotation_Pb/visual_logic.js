...
function home_camera() {
  tweenCamera('', 'extrasv10_mesh16', 1, function() {}, 0);
}
...
eventHTMLElem('click', 'paso2', true, function(event) {
  ...
  setObjTransform('camera1', false, 'position', [-19786.95, 39515.91, 50980.63], false);
  pasos('paso2', '/images/flotation_pb/01-1.png', null, 'celda_mesh279', ['extrasv10_mesh16', 'motorFtPB35_mesh', 'extrasv10_mesh152', 'extrasv10_mesh36', 'celda_mesh294', 'celda_mesh279', 'celda_mesh237', 'celda_mesh221', 'celda_mesh339', 'celda_mesh354', null]);
});
eventHTMLElem('click', 'paso3', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-22311.13, 38695.75, 47357.74], false);
  pasos('paso3', '/images/flotation_pb/03-1.png', null, 'motorFtPB14_mesh', ['motorFtPB14_mesh', 'extrasv10_mesh247', 'motorFtPB13_mesh', 'extrasv10_mesh225', 'motorFtPB15_mesh', 'extrasv10_mesh244']);
});
eventHTMLElem('click', 'paso4', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20841, 39015.42, 47056.18], false);
  pasos('paso4', '/images/flotation_pb/05-1.png', null, 'tanqueAbierto03_mesh', ['tanqueAbierto03_mesh', 'tanqueAbierto04_mesh', 'tanqueAbierto01_mesh', 'tanqueAbierto02_mesh', null, null]);
});
eventHTMLElem('click', 'paso5', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20636.82, 38739.68, 51732.09], false);
  pasos('paso5', '/images/flotation_pb/07-1.png', null, 'extrav12_mesh111', ['extrav12_mesh111', 'extrav12_mesh138', 'extrav12_mesh308', 'extrav12_mesh300', 'extrav11_mesh43', 'extrav12_mesh247', 'extrav12_mesh396', 'extrav12_mesh389', 'extrav12_mesh144', 'extrav12_mesh321', 'valvulasDardo01_mesh', 'extrav12_mesh102', 'extrav12_mesh156', null]);
});
eventHTMLElem('click', 'paso6', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20636.82, 38739.68, 51732.09], false);
  zoomCamera('extrav11_mesh100', 1, function() {
    pasos('paso6', '/images/flotation_pb/08-1.png', null, 'extrav11_mesh100', ['motorFtPB30_mesh', 'extrav11_mesh100', 'BombaFtPB16_mesh', null]);
  });
});
eventHTMLElem('click', 'paso7', true, function(event) {
  ...
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20636.82, 38739.68, 51732.09], false);
  zoomCamera('extrav11_mesh398', 1, function() {
    pasos('paso7', '/images/flotation_pb/09-1.png', null, 'extrav11_mesh398', ['extrav11_mesh398', 'tubo_extrav11_mesh166', 'extrav11_mesh166', null]);
  });
});
eventHTMLElem('click', 'paso8', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-21449.94, 37802.54, 50923.95], false);
  pasos('paso8', '/images/flotation_pb10-1.png', null, 'motorFtPB36_mesh', ['motorFtPB36_mesh', 'guardaBombaFTPB01_mesh', 'BombaFtPB15_mesh', null, 'motorFtPB37_mesh', 'guardaBombaFTPB02_mesh', 'BombaFtPB21_mesh']);
});
eventHTMLElem('click', 'paso9', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-21449.94, 37802.54, 50923.95], false);
  zoomCamera('ciclonesBase01_mesh', 0.5, function() {
    pasos('paso9', '/images/flotation_pb/14-1.png', null, 'ciclonesBase01_mesh', ['ciclonesBase01_mesh', 'Bciclon02_mesh', 'Bciclon01_mesh', 'ciclonesBase01_mesh', null, null]);
  });
});
eventHTMLElem('click', 'paso10', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20442.43, 38563.63, 53531.05], false);
  pasos('paso10', '/images/flotation_pb/15-1.png', null, 'gabVertimill_mesh166', [['gabVertimill_mesh199', 'gabVertimill_mesh281', 'gabVertimill_mesh50'], ['gabVertimill_mesh166', 'gabVertimill_mesh268', 'gabVertimill_mesh108'], ['motorVertimil01_mesh', 'motorVertimil02_mesh', 'motorVertimil03_mesh'], null]);
});
...
Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('//Rendimiento' + '\n' +
...
'    });' + '\n' +
'}' + '\n' +
'//app.renderer.setPixelRatio(0.90); // o 0.5 para aún más rendimiento' + '\n' +
'' + '\n' +
