...
function home_camera() {
  tweenCamera('', 'bombaBF22_mesh', 1, function() {}, 0);
}
...
eventHTMLElem('click', 'all', true, function(event) {
  setObjTransform('camera01', false, 'position', [x_cam, y_cam, z_cam], false);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  handleAnnot(true, 'Zn Filtration Area Spillage Pump', 'mesh_2283', '', 'Thickener A04-DTH', undefined);
  handleAnnot(true, 'Combined Zn Concentrate Primary Sampler', 'mesh_2317', '', 'ZN Pumps', undefined);
  handleAnnot(true, 'Zn Concentrate Thickener', 'mesh_2571', '', 'ZN Pump x', undefined);
  handleAnnot(true, 'Zn Concentrate Thickener U/F Pump #1, 2', 'mesh_876', '', 'ZN Cyclone', undefined);
  handleAnnot(true, 'Zn Concentrate Filter Feed Tank #1, 2', 'mesh_1815', '', 'Ciclón ZN', undefined);
  handleAnnot(true, 'Zn Concentrate Filter Feed Pump #1, 2', 'mesh_1494', '', 'Ciclón ZN', undefined);
  handleAnnot(true, 'Zn Concentrate Filter', 'mesh_1876', '', 'Ciclón ZN', undefined);
  pasos('all', null, null, null, null);
});
eventHTMLElem('click', 'paso2', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 86}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-21114.511478326524, 39867.736934106295, 41594.73038858794], false);
  pasos('paso2', '/images/backfill_pb/01-1.png', null, 'equip5_mesh40', 'tanques');
});
eventHTMLElem('click', 'paso3', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 87}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-22560.279991953186, 42170.28399760281, 37227.479319010505], false);
  pasos('paso3', '/images/backfill_pb/02-1.png', null, 'equip6_mesh182', ['motores1', 'motores2', 'motores3', 'motores4', 'motores5', null]);
});
eventHTMLElem('click', 'paso4', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 88}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-25663.01687019963, 40995.22230033415, 38890.10753885533], false);
  pasos('paso4', '/images/backfill_pb/03-1.png', null, 'Cylinder1534', 'disco');
  changeVis('barandasss29', false);
  changeVis('barandasss29', false);
  changeVis('tuberias2_mesh145', false);
});
eventHTMLElem('click', 'paso5', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 89}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-24356.123155226236, 39831.61545038462, 35255.37976380893], false);
  pasos('paso5', '/images/backfill_pb/05-1.png', null, 'equip4_mesh577', 'motores6');
  changeVis('pCylinder814', false);
  changeVis('pCylinder810', false);
  changeVis('pCylinder806', false);
  changeVis('pCylinder804', false);
  changeVis('pCylinder1100', false);
  changeVis('pCylinder915', false);
  changeVis('pCylinder752', false);
  changeVis('PolyFaceFBXASC032Mesh_ncl1_192', false);
  changeVis('PolyFaceFBXASC032Mesh_ncl1_192', false);
  changeVis('equip4_mesh577', false);
});
eventHTMLElem('click', 'paso6', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 90}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-22480.186572118662, 40453.54015936824, 34533.73614084035], false);
  pasos('paso6', '/images/backfill_pb/06-1.png', null, 'equip8_mesh123', 'faja');
});
eventHTMLElem('click', 'paso7', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 91}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-28268.357081595987, 44138.743683441564, 32405.944109044955], false);
  pasos('paso7', '/images/backfill_pb/x.png', null, 'equip_mesh190', 'tanques2');
});
eventHTMLElem('click', 'paso8', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 92}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-25056.79987675717, 39638.87930102825, 34570.89093509278], false);
  pasos('paso8', '/images/backfill_pb/07-1.png', null, 'equip37', 'twin_mixer');
});
eventHTMLElem('click', 'paso9', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 93}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera01', false, 'position', [-25744.1558232091, 38937.39986372093, 33979.28045147478], false);
  pasos('paso9', '/images/backfill_pb/09-1.png', null, 'equip6_mesh118', 'paste_pump');
  registerSetTimeout(1, function() {
    changeVis('equip6_mesh118', false);
  });
});
...
proceso = 'paso1';
addFog(0.5, 0.5, 0.5, 0.000002, 0, 0);
...
'    var camera = app.scene.getObjectByName("camera01");' + '\n' +
'    if (!camera) {' + '\n' +
'        console.error("No se encontró la cámara \'camera01\'");' + '\n' +
'        return;' + '\n' +
'    }' + '\n' +
'' + '\n' +
...
'    var terreno = app.scene.getObjectByName("terreno_mesh");' + '\n' +
'' + '\n' +
'    if (!terreno) return;' + '\n' +
'' + '\n' +
...
'' + '\n' +
'    // Centro del límite' + '\n' +
'    let centerX = -25391.30693314155;' + '\n' +
'    let centerY = 45562.76886250419;' + '\n' +
'    let centerZ = 36130.62960878772;' + '\n' +
'' + '\n' +
