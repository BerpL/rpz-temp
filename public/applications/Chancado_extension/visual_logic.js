...
function home_camera() {
  tweenCamera('', 'equipos02orientacion_3DFBXASC032Solid_ncl1_13', 1, function() {}, 0);
}
...
eventHTMLElem('click', 'paso2', true, function(event) {
  ...
  setObjTransform('camera1', false, 'position', [-9582.65, 39821.34, 40775.93], false);
  pasos('paso2', '/images/crushing/01-1.png', null, 'pCylinder1300', ['pCylinder1300', 'pCylinder1329', 'pCube2961', 'pCube3322', null]);
});
eventHTMLElem('click', 'paso3', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-8093.71, 40237.52, 41849.75], false);
  pasos('paso3', '/images/crushing/02-1.png', null, 'Subentidad4213', ['Subentidad4213', 'Subentidad4214', 'FBXASC051DFBXASC032Solid_ncl1_43', 'pCube3260', 'equipos02orientacion_3DFBXASC032Solid_ncl1_13', 'FBXASC051DFBXASC032Solid_ncl1_175', 'FBXASC051DFBXASC032Solid_ncl1_168', null]);
});
eventHTMLElem('click', 'paso4', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-10279.26, 40027.77, 42361.17], false);
  pasos('paso4', '/images/crushing/03-1.png', null, 'FBXASC051DFBXASC032Solid_ncl1_152', ['FBXASC051DFBXASC032Solid_ncl1_152', 'pCube3083', 'FBXASC051DFBXASC032Solid_ncl1_137', 'FBXASC051DFBXASC032Solid_ncl1_111', 'pCube3151']);
});
eventHTMLElem('click', 'paso5', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-10279.26, 40027.77, 42361.17], false);
  pasos('paso5', '/images/crushing/05-1.png', null, 'FBXASC051DFBXASC032Solid_ncl1_61', ['FBXASC051DFBXASC032Solid_ncl1_61', 'FBXASC051DFBXASC032Solid_ncl1_178', 'FBXASC051DFBXASC032Solid_ncl1_174']);
});
eventHTMLElem('click', 'paso6', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-8828.1, 40595.43, 46677.75], false);
  pasos('paso6', '/images/crushing/04-1.png', null, 'FBXASC051DFBXASC032Solid_ncl1_177', ['FBXASC051DFBXASC032Solid_ncl1_177', 'Subentidad5150', 'Subentidad5229', 'Subentidad4794', 'Subentidad4790', 'Subentidad4825', 'Subentidad4891', 'Subentidad4858', 'Subentidad4825', 'equipos02orientacion_3DFBXASC032Solid_ncl1_17', 'Subentidad4899', 'ASTGRATING_ncl1_169', ['Subentidad4872', 'ASTGRATING_ncl1_166', null]]);
});

'FBXASC051DFBXASC032Solid_ncl1_152';
...
'app.addEventListener("beforeRender", hideObjectsOutsideView);' + '\n' +
'')))(appInstance, v3d, PL, VARS, PROC);
...
'    var terreno = app.scene.getObjectByName("sueloooo:pasted__terreno_mesh");' + '\n' +
'' + '\n' +
'    if (!terreno) return;' + '\n' +
'    ' + '\n' +
'' + '\n' +
...
'' + '\n' +
'    if (intersects.length > 0) {' + '\n' +
'        var groundY = intersects[0].point.y + 300;' + '\n' +
...
'    // Centro del límite' + '\n' +
'    let centerX = -7647.54;' + '\n' +
'    let centerY = 47243.67;' + '\n' +
'    let centerZ = 48244.98;' + '\n' +
'' + '\n' +
