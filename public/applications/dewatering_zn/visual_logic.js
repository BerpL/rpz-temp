...
function home_camera() {
  tweenCamera('', 'mesh_1311', 1, function() {}, 0);
}
...
eventHTMLElem('click', 'all', true, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('function changeAnnotationsStyle(maxWidth, maxHeight, fontSize) {' + '\n' +
  '    document.querySelectorAll(\'.v3d-annotation\').forEach(annotation => {' + '\n' +
  '        annotation.style.maxWidth = maxWidth + \'px\';' + '\n' +
  '        annotation.style.maxHeight = maxHeight + \'px\';' + '\n' +
  '        ' + '\n' +
  '        let textElement = annotation.querySelector(\'.v3d-annotation-text\');' + '\n' +
  '        if (textElement) {' + '\n' +
  '            textElement.style.fontSize = fontSize + \'px\';' + '\n' +
  '        }' + '\n' +
  '    });' + '\n' +
  '}' + '\n' +
  'changeAnnotationsStyle(320, 90, 0.2); ' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

});
eventHTMLElem('click', 'paso2', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 70}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-20378, 37456, 54878], false);
  pasos('paso2', '/images/dewatering_zn/01-1.png', null, 'mesh_2283', ['mesh_2283', 'mesh_2519', 'mesh_1137', 'mesh_39', 'mesh_833']);
});
eventHTMLElem('click', 'paso3', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 71}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-19057, 38585.56844510039, 53569.60917357068], false);
  pasos('paso3', '/images/dewatering_zn/02-1.png', null, 'mesh_2317', ['mesh_2317', 'mesh_1268', 'mesh_1120', 'mesh_1369', 'mesh_923', 'mesh_2449', 'mesh_2764', 'mesh_2012', 'mesh_791', 'mesh_1608', null]);
});
eventHTMLElem('click', 'paso4', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 72}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-19057, 38585.56844510039, 53569.60917357068], false);
  pasos('paso4', '/images/dewatering_zn/03-1.png', null, 'mesh_2571', ['mesh_1165', 'mesh_2571', 'mesh_1521']);
});
eventHTMLElem('click', 'paso5', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 73}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-17443.422759780275, 37496.09419783489, 54929.45605237306], false);
  pasos('paso5', '/images/dewatering_zn/04-1.png', null, 'mesh_876', 'bomba');
});
eventHTMLElem('click', 'paso6', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 74}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-21448.895977043736, 39276.61826654609, 54586.67874943683], false);
  pasos('paso6', '/images/dewatering_zn/05-1.png', null, 'mesh_1815', ['mesh_1494', 'mesh_598', null]);
});
eventHTMLElem('click', 'paso7', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 75}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-21650.10897433401, 39478.64041413845, 56427.42609218353], false);
  pasos('paso7', '/images/dewatering_zn/06-1.png', null, 'mesh_1494', 'bomba2');
});
eventHTMLElem('click', 'paso8', true, function(event) {});
eventHTMLElem('click', 'paso9', true, function(event) {

  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2: 76}, \'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);

  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-19651.70917967501, 39331.43981147541, 58292.22301776512], false);
  pasos('paso9', '/images/dewatering_zn/08-1.png', null, 'mesh_1876', 'rojo');
  registerSetTimeout(1, function() {
    changeVis('casa', false);
  });
});
