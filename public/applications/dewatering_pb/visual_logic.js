...
function home_camera() {
  tweenCamera('', 'cilindroP_DWPB_01_mesh', 1, function() {}, 0);
}
...
eventHTMLElem('click', 'paso2', true, function(event) {
  ...
  setObjTransform('camera1', false, 'position', [-19710.35, 39402.84, 51387.75], false);
  pasos('paso2', '/images/dewatering_pb/03-1.png', null, 'cilindroP_DWPB_01_mesh', ['cilindroP_DWPB_01_mesh', 'motorFtPB_extra01_mesh', 'escaleraCilin_DWPB_01_mesh', 'baranda06Cil_DWPB_02_mesh24', 'baranda06Cil_DWPB_02_mesh18', 'baranda06Cil_DWPB_02_mesh23', 'pCube3738']);
});
eventHTMLElem('click', 'paso3', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-23567.85, 38646.32, 53678.42], false);
  pasos('paso3', '/images/dewatering_pb/04-1.png', null, 'espesador_meshh', ['rejaEspesador03_mesh001', 'espesador_meshh', 'extrav3_mesh247']);
});
eventHTMLElem('click', 'paso4', true, function(event) {
  changeVis(['ALL_OBJECTS'], true);
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '', undefined);
  setObjTransform('camera1', false, 'position', [-23567.85, 38646.32, 53678.42], false);
  zoomCamera('polySurface1450', 0.5, function() {
    pasos('paso4', '/images/dewatering_pb/07-1.png', null, 'polySurface1450', 'polySurface1450');
  });
  registerSetTimeout(0.5, function() {
    changeVis('pCube3735', false);
  });
});
